...
const SM_ARTIGOS = [
  ...
  { file: 'artigo-mindset-sedentarismo.html', icon: '🧠', cat: 'Estilo de Vida', name: 'Mindset de Crescimento Contra o Sedentarismo', desc: 'Como aplicar os conceitos do livro Mindset, de Carol Dweck, para sair do sedentarismo de forma prática.' },
